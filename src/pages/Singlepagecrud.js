...
const Singlepagecrud = () => {
    ...
    const fetchUsers = () => {
      axios.get('https://sweet-website-backend.onrender.com/users')
    ...
    const createUser = () => {
      ...
      axios.post("https://sweet-website-backend.onrender.com/users", userData)
        .then(res => {
    ...
    const deleteUser = (userId) => {
      axios.delete(`https://sweet-website-backend.onrender.com/users/${userId}`)
        .then(() => {
